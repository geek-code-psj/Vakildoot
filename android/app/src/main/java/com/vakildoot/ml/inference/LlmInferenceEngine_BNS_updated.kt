...
/**
 * LlmInferenceEngineBNS (BNS 2023 Updated)
 *
 * UPDATED VERSION: Wraps ExecuTorch's LlmModule to run Phi-4-mini-instruct (flagship)
 * or Gemma-3-2B (midrange) entirely on-device.
 *
 * KEY DIFFERENCE FROM ORIGINAL:
 * This version includes updated Indian legal system prompt with BNS 2023 laws
 * (Bharatiya Nyaya Sanhita) effective July 1, 2024.
 *
 ...
 *   - System prompt baked in with updated Indian legal context (BNS 2023)
 */
@Singleton
class LlmInferenceEngineBNS @Inject constructor(
